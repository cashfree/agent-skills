...
The issue context is appended at the **end** of this prompt as plain `KEY: value`
lines — `ISSUE_NUMBER`, `ISSUE_TITLE`, and `REPO`. Read them from there before you start.
...
**d) Public docs / portal** — use your web search / page-fetch capability to corroborate
